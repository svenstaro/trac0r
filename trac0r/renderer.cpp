...
std::vector<glm::vec4> &Renderer::render(bool scene_changed, int stride_x, int stride_y) {
    ...
    auto private_mem_size =
        0; // We do this because pocl currently doesn't implement this and will exit(1)
    ...
    if (m_print_perf) {
        fmt::print(
            "    Executing kernel ({}x{}/{}x{}, global work items: {}, items per work group: "
        ...
        fmt::print("    Max work group size: {}, Local mem size used by kernel: {} KB, minimum "
                   "private mem "
